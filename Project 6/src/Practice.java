...
public class Practice
{
	...
	public static String copyScrambledLetter(String word) {
	...
	public static int numUserGuesses(String scrambledWord, Scanner keyboard, String word) {
	...
	public static void printAnswer(int wordPoints, int pointsEarned, String word) {
